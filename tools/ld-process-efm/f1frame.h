...
// Taken from https://club.myce.com/t/unscramble-sectors/151734/3
// This table should be XOR'd with either the scrambled sector (to
// descramble it) or the descrambled sector (to scramble it).
