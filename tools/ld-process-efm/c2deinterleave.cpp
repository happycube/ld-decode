...
C2Deinterleave::C2Deinterleave()
{
    ...
    validDeinterleavedC2s = 0;
    invalidDeinterleavedC2s = 0;
}
...
void C2Deinterleave::reportStatus(void)
{
    ...
    qInfo() << "  Total number of C2s processed =" << validDeinterleavedC2s + invalidDeinterleavedC2s;
    qInfo() << "  of which" << validDeinterleavedC2s << "were valid and" << invalidDeinterleavedC2s << "were invalid";
