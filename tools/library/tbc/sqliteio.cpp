...
{
    QSqlQuery query(db);
    query.prepare("INSERT INTO pcm_audio_parameters (capture_id, bits, is_signed, "
...
{
    QSqlQuery query(db);
    query.prepare("INSERT INTO vits_metrics (capture_id, field_id, w_snr, b_psnr) VALUES (?, ?, ?, ?)");
...
{
    QSqlQuery query(db);
    query.prepare("INSERT INTO vbi (capture_id, field_id, vbi0, vbi1, vbi2) VALUES (?, ?, ?, ?, ?)");
...
{
    QSqlQuery query(db);
    query.prepare("INSERT INTO vitc (capture_id, field_id, vitc0, vitc1, vitc2, vitc3, "
...
{
    QSqlQuery query(db);
    query.prepare("INSERT INTO closed_caption (capture_id, field_id, data0, data1) VALUES (?, ?, ?, ?)");
