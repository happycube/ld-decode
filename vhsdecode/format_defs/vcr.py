def get_rfparams_pal_vcr(RFParams_PAL):
    ...
    RFParams_PAL_VCR["video_bpf_order"] = 1
    RFParams_PAL_VCR["video_lpf_extra"] = 6000000
    RFParams_PAL_VCR["video_lpf_extra_order"] = 3
    RFParams_PAL_VCR["video_hpf_extra"] = 1400000
    RFParams_PAL_VCR["video_hpf_extra_order"] = 1
    ...
    RFParams_PAL_VCR["deemph_mid"] = 360000
    RFParams_PAL_VCR["deemph_gain"] = 10

    # This has not really been stress-tested due to lack of crummy VCR samples.
    RFParams_PAL_VCR["boost_bpf_low"] = 5400000
    RFParams_PAL_VCR["boost_bpf_high"] = 6000000
