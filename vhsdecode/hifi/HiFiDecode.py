...
class HiFiDecode:
    ...
    def resample_if_worker(
        ...
        while True:
            ...
            audioL = audioL.astype(decoder_state.audio_dtype, copy=False)
            audioR = audioR.astype(decoder_state.audio_dtype, copy=False)
            ...
            pre_trim = worker_params.pre_trim
