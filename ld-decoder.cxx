...
const double f_lpf40_12_hamming_b[] {-3.676166293481025e-03, -8.560637126685469e-03, -8.674527291567265e-03, 2.855772338716820e-02, 1.214375123547039e-01, 2.307614804007515e-01, 2.803092291382203e-01, 2.307614804007515e-01, 1.214375123547039e-01, 2.855772338716820e-02, -8.674527291567265e-03, -8.560637126685477e-03, -3.676166293481024e-03};
...
Filter f_lpf40_12(12, NULL, f_lpf40_12_hamming_b);
...
//	FM_demod video(2048, {7600000, 8100000, 8400000, 8700000, 9000000, 9300000}, &f_afilt12, {&f_lpf40_12, &f_lpf40_12, &f_lpf40_12, &f_lpf40_12, &f_lpf40_12, &f_lpf40_12}, NULL);
	FM_demod video(2048, {7600000, 8100000, 8400000, 8700000, 9000000, 9300000}, &f_afilt12, {&f_lpf42_12, &f_lpf42_12, &f_lpf42_12, &f_lpf42_12, &f_lpf42_12, &f_lpf42_12}, NULL);
...
//	FM_demod video(2048, {8500000}, &f_afilt12, {&f_lpf40_12}, NULL);
//	FM_demod video(2048, fb, NULL, &f_lpf45, NULL);

	double deemp[8], orig[8];

	for (int i = 0; i < 8; i++) deemp[i] = 8300000;
